...
class YOLONet(object):
    ...
    def build_network(self, inputs, dropout_keep_prob=0.5, is_training=True, spatial_squeeze=True, fc_conv_padding="VALID", global_pool=False, scope='vgg_16'):
        with tf.variable_scope(scope, 'vgg_16', [inputs]) as sc:
            ...
            with slim.arg_scope([slim.conv2d, slim.fully_connected],
                ...
                net = slim.dropout(net, keep_prob=dropout_keep_prob, is_training=is_training, scope='dropout_35')
        ...
        return net
                ...
                #     net = slim.dropout(net, dropout_keep_prob, is_training=is_training,
                #                     scope='dropout7')
                #     net = slim.conv2d(net, len(self.classes), [1, 1],
                #                     activation_fn=None,
                #                     normalizer_fn=None,
                #                     scope='fc8')
                #     if spatial_squeeze:
